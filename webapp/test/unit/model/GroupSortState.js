sap.ui.define([
	"de/integrata/fioi/curd/model/GroupSortState",
	...
	QUnit.test("Should always return a sorter when sorting", function(assert) {
		...
		assert.strictEqual(this.oGroupSortState.sort("Custname").length, 1, "The sorting by Custname returned a sorter");
	});
	...
	QUnit.test("Should set the grouping to None if the user sorts by Custname and there was a grouping before", function(assert) {
		// Arrange
		this.oModel.setProperty("/groupBy", "");

		this.oGroupSortState.sort("Custname");
