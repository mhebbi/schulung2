sap.ui.define([
	...
	function getFrameUrl(sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("de/integrata/fioi/curd/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#schulung2-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#schulung2-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("de.integrata.fioi.curd.test.integration.pages.Common", {
		...
		getMockServer: function() {
			return new Promise(function(success) {
				Opa5.getWindow().sap.ui.require(["de/integrata/fioi/curd/localService/mockserver"], function(mockserver) {
