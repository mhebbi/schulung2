		...
		onTheMasterPage: {
			...
			actions: {
				...
				iRememberTheListItem: function(oListItem) {
					...
					this.getContext().currentItem = {
						...
						title: oBindingContext.getProperty("Custname")
					};
				},
			...
			assertions: {
				...
				theListHeaderDisplaysZeroHits: function() {
					return this.waitFor({
						...
						matchers: new PropertyStrictEquals({
							name: "title",
							value: "FlugkundenSet (0)"
						}),
						success: function() {
							Opa5.assert.ok(true, "The list header displays 'FlugkundenSet (0)'");
						},
				...
				theListShouldBeSortedAscendingOnName: function() {
					return this.theListShouldBeSortedAscendingOnField("Custname");
				},
				...
				theListShouldHaveAllEntries: function() {
					...
					// retrieve all FlugkundenSet to be able to check for the total amount
					...
					return this.waitFor({
						...
						success: function(oList) {
							...
							this.waitFor({
								...
								matchers: new PropertyStrictEquals({
									name: "title",
									value: "FlugkundenSet (" + iExpectedLength + ")"
								}),
								success: function() {
