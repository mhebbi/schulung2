/*global location */
sap.ui.define([
	"de/integrata/fioi/curd/controller/BaseController",
	"sap/ui/model/json/JSONModel",
	"de/integrata/fioi/curd/model/formatter",
	"sap/m/MessageBox",
	"sap/m/MessageToast"
], function(BaseController, JSONModel, formatter, MessageBox, MessageToast) {
	"use strict";

	return BaseController.extend("de.integrata.fioi.curd.controller.Detail", {
		...
		onDelete: function() {
			...
			var oViewModel = this.getModel("detailView"),
				...
				sObjectHeader = this._oODataModel.getProperty(sPath + "/Custname"),
		...
		_onObjectMatched: function(oEvent) {
			...
			this.getModel().metadataLoaded().then(function() {
				var sObjectPath = this.getModel().createKey("FlugkundenSet", oParameter);
