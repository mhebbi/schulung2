sap.ui.define([
	...
	return BaseController.extend("de.integrata.fioi.curd.controller.CreateEntity", {
		...
		_onCreate: function(oEvent) {
			...
			var oContext = this._oODataModel.createEntry("FlugkundenSet", {
		...
		_fnEntityCreated: function(oData) {
			var sObjectPath = this.getModel().createKey("FlugkundenSet", oData);
