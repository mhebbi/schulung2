sap.ui.define([
	...
	return BaseObject.extend("de.integrata.fioi.curd.model.GroupSortState", {
		 ...
		 * @class
		 * @public
		 * @alias de.integrata.fioi.curd.model.GroupSortState
		 */
		...
		group: function(sKey) {
			...
			if (sKey === "") {
				...
				this._oViewModel.setProperty("/sortBy", "Custname");
			}
